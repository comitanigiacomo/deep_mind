...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 15 }) {
  const [hasDragged, setHasDragged] = useState(false);
  const [fadeOut, setFadeOut] = useState(false);

  return (
    <div className="lanyard-wrapper" style={{ position: 'relative' }}>
      <Canvas
...
function Band({ maxSpeed = 50, minSpeed = 0, onFirstDrag = () => {} }) {
