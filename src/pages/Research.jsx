...
const papers = [
  {
    ...
    abstract:
      'Empirical replication of the Double Descent phenomenon in linear models. Built from-scratch closed-form solutions for ordinary and ridge regression to validate that prediction error can decrease, increase, then decrease again as model complexity grows beyond the interpolation threshold.',
  ...
  },
  {
    ...
    course: 'MSc Computer Science — UniMi',
    abstract:
      'Python implementation of Flajolet-Martin and Bloom Filter algorithms applied to a live stream of New York Times articles. Designed under strict O(1) RAM constraints using lazy evaluation to handle massive data in constant memory.',
    ...
    <section id="research" className="research-section" ref={sectionRef}>
      <div className={`research-inner ${visible ? 'research--visible' : ''}`}>
        ...
        <p className="research-subtitle">
          Academic projects and analyses developed during my MSc in Computer Science at Università degli Studi di Milano.
        </p>
